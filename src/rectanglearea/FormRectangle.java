...
public class FormRectangle extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        RectAreaLable = new javax.swing.JLabel();
        ...
        caculater = new javax.swing.JButton();
        oututLable = new javax.swing.JLabel();
        ...
        RectAreaLable.setText("Rectangle Area Program");

        widthLable.setText("Enter the width here");

        lengthLable.setText("Enter the length here");
        ...
        caculater.setText("Calculate Area");
        caculater.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                caculaterActionPerformed(evt);
            }
        });

        oututLable.setText("Output will go here.");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(147, 147, 147)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(RectAreaLable)
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addComponent(oututLable)
                                        .addComponent(caculater))))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(81, 81, 81)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(lengthInput, javax.swing.GroupLayout.DEFAULT_SIZE, 96, Short.MAX_VALUE)
    ...
    private void caculaterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_caculaterActionPerformed
        double length, width, area;
        length=Double.parseDouble(lengthInput.getText());
        width=Double.parseDouble(widthInput.getText());
        area=length*width;
        oututLable.setText("The area of your rectangle is, " + area);
    }//GEN-LAST:event_caculaterActionPerformed
    ...
    private javax.swing.JLabel RectAreaLable;
    private javax.swing.JButton caculater;
    ...
    private javax.swing.JLabel oututLable;
